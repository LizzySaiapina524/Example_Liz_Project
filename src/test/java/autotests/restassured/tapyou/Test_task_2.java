...
import technicalclasses.RestAssured.TapYouTestTaskResponses;
...
public class Test_task_2 {
    ...
    private TapYouTestTaskResponses.GetUserInfo response;
    ...
    public void ExistingId() {
        ...
        TapYouTestTaskResponses.GetUserInfo body =
                response.as(TapYouTestTaskResponses.GetUserInfo.class);
    ...
    public void NotExistingId() {
        ...
        // Проверка на то, что присутствуют все необходимые поля
        TapYouTestTaskResponses.IncorrectResponseScheme body =
                response.as(TapYouTestTaskResponses.IncorrectResponseScheme.class);
    ...
    public void StringInsteadIntId() {
        ...
        // Проверка на то, что присутствуют все необходимые поля
        TapYouTestTaskResponses.GetUserInfo body =
                response.as((Type) TapYouTestTaskResponses.GetUserInfo.class);
    ...
    public void EmptyIdValue() {
        ...
        // Проверка на то, что присутствуют все необходимые поля
        TapYouTestTaskResponses.IncorrectResponseScheme body =
                response.as((Type) TapYouTestTaskResponses.IncorrectResponseScheme.class);
